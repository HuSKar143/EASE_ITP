...
<head>
  ...
  <link href="{{asset('assets/css/sb-admin.css')}}" rel="stylesheet"> @yield('css')
</head>
...
@yield('content')
    ...
    <script type="text/javascript" src="{{asset('assets/jquery-easing/jquery.easing.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/datatables/dataTables.bootstrap4.js')}}"></script>
